...
parser.add_argument('--train_set', default='baidu-train', type=str, help='train dataset name')
parser.add_argument('--val_set', default='baidu-val', type=str, help='valid dataset name')
parser.add_argument('--exp', default='baidu', type=str, help='experiment setting')
...
class PSNRLoss(nn.Module):
    ...
    def forward(self, pred: torch.Tensor,
        ...
        loss_l2 = self.l2loss(pred, target).mean(dim=(1, 2, 3))
        return self.scale * torch.log(loss_l2 + 1e-8).mean()
...
def main():
    ...
    train_loader = DataLoader(train_dataset,
                              ...
                              pin_memory=True,
                              drop_last=True,
                              persistent_workers=args.num_workers > 0)  # comment this line for cache_memory
